<!-- Proves del button function Error Message -->
...
//     };
    ...
    //---------- Button Funtion  TEST -3-  ---------//
    //----------(Codi del Shopping List)  ----------//
